package controller;
// controller.GraphViz.java - a simple API to call dot from Java programs
...
/**
 * <dl>
 * <dt>Purpose: controller.GraphViz Java API
 * <dd>
 *
 * <dt>Description:
 ...
 * <dd>
 * <pre>
 *    controller.GraphViz gv = new controller.GraphViz();
...
public class GraphViz
{
     ...
     * creates a new controller.GraphViz object that will contain a graph.
     * Windows:
    ...
    public GraphViz() {
        if (GraphViz.osName.contains("Windows")) {
            this.tempDir = "c:/Users/Mael/IdeaProjects/Graph_TP_option1";
            //this.executable = "c:/Program Files (x86)/Graphviz2.38/bin/dot.exe";
            //this.executable = "\"C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot.exe\"";
            //this.executable = "C:/Users/Mael/IdeaProjects/Graph_TP_option1/lib/Graphiz/Windows_bin/dot.exe";
     ...
     */
    public byte[] get_img_stream(File dot, String type, String representationType)
    {
        File img;
        byte[] img_stream = null;
        try {
...
} // end of class controller.GraphViz
