...
public class test_AdjecencyMatrix {
    ...
    public static void main (String[] args) throws WrongSizeException, VertexInexistentException {
        ...
        System.out.println("size of matriceTest : " +  matriceTest.getData().size());
        ...
        System.out.println(matriceTest.getData().toString());
        ...
        edge3.add(2);
        edge3.add(3);
        System.out.println("vertex3.get(2)" + edge3.get(2));
